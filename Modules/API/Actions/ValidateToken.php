<?php
class ModulesAPIActionsValidateToken extends KernelObject{
	public function __construct($cfg=null){
		parent::__construct($cfg);
		
		$this->useDefinition('Object.Action');
		
		$this->setValue('ID','Modules.API.Actions.ValidateToken');
		$this->setValue('Name','Validate API Token');
		$this->setValue('Description', 'Validates an API Token');
		$this->setValue('Author', 'Justin Pradier');
		$this->setValue('Version', '1.0.0');
		
		$this->addAttribute('Session', 'Modules.API.Session', true);
		$this->addAttribute('Token', array('Object.String', 'Modules.API.Token'), true);
