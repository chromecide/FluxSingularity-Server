Ext.define('DockUI.Sidebar.DropTarget', {
    ...
    notifyDrop: function(dd, e, data) {
        ...
        if (this.portal.fireEvent('validatedrop', dropEvent) !== false && this.portal.fireEvent('beforedrop', dropEvent) !== false) {
            ...
            if(Ext.getClassName(panel)=='DockUI.DockletLauncher' && panel.Docklet){	
            	panel = Ext.ClassManager.instantiate(panel.Docklet, panel.DockletCfg);
            }
    ...
    getGrid: function() {
        ...
        box.columnX = [];
        this.target.items.each(function(c) {
            box.columnX.push({
                x: c.el.getX(),
                w: c.el.getWidth()
            });
